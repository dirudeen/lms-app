...
export const attachmentTable = pgTable(
  ...
  (table) => {
    return {
      ...
      attachmentTableCourseIdx: index("attachment_table_course_idx").on(
        table.courseId
      ),
    };
  }
...
export const chapterTable = pgTable(
  ...
  (table) => {
    return {
      chapterTableCourseIdx: index("chapter_table_course_idx").on(
        table.courseId
      ),
    };
  }
...
export const userProgressTable = pgTable(
  ...
  (table) => {
    return {
      userProgressTableChapterIdx: index("user_progress_table_chapter_idx").on(
        table.chapterId
      ),
    };
  }
...
export const purchaseTable = pgTable(
  ...
  (table) => {
    return {
      puchaseTableCourseIdx: index("puchase_table_course_idx").on(
        table.courseId
      ),
      userIdCourseIdUnique: unique("user_id_course_id_unique").on(
        table.userId,
        table.courseId
      ),
    };
